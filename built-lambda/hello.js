...
const hello = async event => {
  try {
    ...
    const raw = await Object(node_fetch__WEBPACK_IMPORTED_MODULE_1__["default"])(`${url}${company}`);
...
exports.handler = async (event, context) => Object(_lambda_helpers__WEBPACK_IMPORTED_MODULE_0__["authorize"])(context.clientContext.user, async () => hello(event));
